...
if __name__ == "__main__":
    if len(sys.argv) == 7:
        ...
        percentage_in_CI = sys.argv[5]
        percentage_of_CI =sys.argv[6]
        reader = ConfigParser()
        reader.read(config)
        ...
        inference_tool=Inference(activities_col_name,caseIDs_col_name,timestamps_col_name,transition_names,component_set,dynamic)
